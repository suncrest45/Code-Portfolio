...
namespace CS280 
{
    ...
    class BSTmap 
	{
		public:
			class Node 
			{
				...
				protected:
					...
					friend class BSTmap;
					friend class AVLmap <KEY_TYPE, VALUE_TYPE>;

					template <typename ANYK_TYPE, typename ANYV_TYPE>
					friend class AVLmap;
			};
        private:
		...
		public:
			...
			virtual VALUE_TYPE& operator[](KEY_TYPE const& key);
		...
		protected:
					...
					void CopyTree(Node* node, Node*& newNode, Node* parent);
